...
<body class="bg-bg text-text">
  ...
  <header class="h-full">
    <section class="my-5">
      ...
      >';
          echo "<a class='block' href='book.php?slug=" . $book['slug'] . "'>";
          echo "<h1 class='text-3xl text-center text-second'>" . $book['title'] . "</h1>";
          echo "<p class='text-md my-5 text-center italic'>" . $book['description'] . "</p>";
          echo '</a>';
          echo '</div>';
        }
        ?>
      ...
      <div class="flex justify-center my-5">
        <a class="text-2xl text-second underline focus:text-primary" href="./books.php">Rendez-vous ici pour tous les
          livres</a>
      </div>
    </section>
    <section class="my-5">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 place-items-center">
        ...
        $sql = "SELECT * FROM music ORDER BY created_at DESC LIMIT 3";
        $stmt = $pdo->query($sql);
      ...
      class="border-2 my-5 border-text p-4 w-4/5 break-words rounded-es-3xl rounded-tr-3xl duration-200 hover:rounded-es-none hover:rounded-tr-none hover:rounded-ss-3xl hover:rounded-br-3xl"
      >';
          echo "<a class='block' href='song.php?slug=" . $song['slug'] . "'>";
          echo "<h1 class='text-3xl text-center text-second'>" . $song['title'] . "</h1>";
          echo "<p class='text-md my-5 text-center italic'>" . $song['description'] . "</p>";
          echo '</a>';
          echo '</div>';
        }
        ?>
      ...
      <div class="flex justify-center my-5">
        <a class="text-2xl text-second underline focus:text-primary" href="./music.php">Rendez-vous ici pour tous les
          musiques</a>
      </div>
    </section>
    <section class="my-5">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 place-items-center">
        ...
        foreach ($articles as $article) {
          echo '<div class="border-2 my-5 border-text p-4 w-4/5 break-words rounded-es-3xl rounded-tr-3xl duration-200 hover:rounded-es-none hover:rounded-tr-none hover:rounded-ss-3xl hover:rounded-br-3xl">';
      ...
      <div class="flex justify-center my-5">
        <a class="text-2xl text-second underline focus:text-primary" href="./blog.php">Rendez-vous ici pour tous les
          articles</a>
      </div>
    </section>
  </header>
