...
<body class="bg-bg text-text">
  ...
  <div class="flex justify-center items-center h-auto my-24">
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form enctype="multipart/form-data" class="space-y-6" action="./auth/auth-register.php" method="post">
        <div>
          <label for="email" class="block text-sm font-medium leading-6 text-gray-900">
            Adresse mail :
          </label>
          <div class="mt-2">
            <input name="email" id="email" type="email" autocomplete="off" required placeholder="Email"
      ...
      <p class="mt-10 text-center flex items-center justify-center text-sm text-gray-500 dark:text-gray-300">
        Déjà un compte ?
        <a href="./login.html" class="font-semibold mx-3 leading-6 text-second underline focus:text-primary">
          Connecte-toi !
        </a>
      </p>
    </div>
